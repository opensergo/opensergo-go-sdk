...
func (sampleRateLimitStrategySubscriber SampleRateLimitStrategySubscriber) OnSubscribeDataUpdate(subscribeKey model.SubscribeKey, data interface{}) (bool, error) {
